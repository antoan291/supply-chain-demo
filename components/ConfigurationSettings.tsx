      ...
      <div className="px-6 py-4 border-b border-corporate-700 bg-corporate-800 rounded-t-lg flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Manage global risk parameters and automation rules.
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            variant="outline"
            size="sm"
            className="bg-corporate-900 border-corporate-700 text-gray-300 hover:text-white"
          >
            ...
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-corporate-700">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Define confidence boundaries for AI decision making.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              <div>
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-mono text-corporate-accentLight">
                    {confidenceThreshold}%
                  </span>
                </div>
                <input
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Documents with a confidence score below {confidenceThreshold}%
                  will automatically trigger a human review task.
                </p>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-corporate-900/50 rounded-md border border-corporate-700">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-gray-500">
                    Skip manual review for scores 98%
                  </span>
                </div>
                <button
                  onClick={() => setAutoApproval(!autoApproval)}
                  className="text-corporate-accentLight transition-colors hover:text-white"
                >
                  {autoApproval ? (
                    <ToggleRight size={32} />
                  ) : (
              ...
              <div className="flex items-center justify-between p-3 bg-corporate-900/50 rounded-md border border-corporate-700">
                <div className="flex flex-col">
                  <span className="text-sm text-gray-200 font-medium">
                    Force Audit on New Vendors
                  </span>
                  <span className="text-xs text-gray-500">
                    Always flag documents from unknown entities
                  </span>
                </div>
          ...
          <div className="bg-corporate-800 border border-corporate-700 rounded-lg p-6">
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-corporate-700">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Configure how the system communicates exceptions.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-300">
                  Critical Risk Alerts (Email)
                </span>
                <button
                  onClick={() => setEmailAlerts(!emailAlerts)}
                  className="text-corporate-accentLight"
                >
                  {emailAlerts ? (
                    <ToggleRight size={32} />
                  ) : (
              ...
              <div className="mt-6 pt-4 border-t border-corporate-700">
                ...
                <input
                  type="email"
                  value="security-ops@axiomchain.com"
                  readOnly
                  className="w-full bg-corporate-900 border border-corporate-700 rounded px-3 py-2 text-sm text-gray-300 focus:outline-none focus:border-corporate-accent"
                />
              </div>
            </div>
          </div>
            ...
            <div className="mt-6">
              ...
              <div className="bg-corporate-900 border border-corporate-700 rounded-md p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    Currently utilizing Flash for extraction and Pro for audit
                    tasks.
                  </p>
                </div>
