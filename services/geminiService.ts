 ...
 */
export const performQuickExtraction = async (text: string): Promise<DocumentAnalysisResult> => {
  try {
 ...
 */
export const performDeepAudit = async (text: string): Promise<DocumentAnalysisResult> => {
  try {
 ...
 */
export const performMarketContextCheck = async (text: string): Promise<DocumentAnalysisResult> => {
  try {
    const model = 'gemini-3-flash-preview';
    const prompt = `
